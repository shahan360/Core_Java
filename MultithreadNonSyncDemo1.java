...
public class MultithreadNonSyncDemo1 {
    public static void main(String[] args) {
        System.out.println("Creating an object p of Printer class");
        Printer p = new Printer();
        System.out.println("Creating objects st as star printer and hs as hash printer objects and assigning printer object p to them");
