class MyThread extends Thread // This is the child thread which is executed by the JVM
{
...
public class MultithreadingDemo_Direct // Directly run this file
{
    public static void main(String[] args) // This is the main thread which is executed by the JVM
    {
        ...
        for(int i=10;i>=1;i--) // This loop is executed by the main thread and the child thread is executed concurrently with the main thread
        {
            ...
            }catch(Exception e) // This block is executed by the main thread
            {
