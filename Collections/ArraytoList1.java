...
public class ArraytoList1 { // List is an interface and Arrays is its class
    public static void main(String[] args) { //main method starts
        ...
        List<String> listFromArray = new ArrayList<>(Arrays.asList(array)); //creating an instance of ArrayList and then creating a list from the array using Arrays.asList() method
